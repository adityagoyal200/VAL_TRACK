...
INSTALLED_APPS = [
    # daphne must come before django.contrib.staticfiles so runserver serves ASGI (websockets)
    "daphne",
...
# Riot data provider (HenrikDev for v1, official Riot API post-approval)
HENRIKDEV_API_KEY = env("HENRIKDEV_API_KEY", default="")
